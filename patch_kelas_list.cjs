...
if (!code.includes('const [editingClassId')) {
  code = code.replace(
...
const listRegex = /<div className="grid grid-cols-1 md:grid-cols-2 gap-4">[\s\S]*?<\/div>\s*<\/div>\s*\)\}\s*<\/div>\s*\{selectedClassForChapters/m;
                  ...
                  <div className="space-y-3 mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {allClasses.filter(c => c.type !== "alumni").map((c) => {
                        ...
                        return (
                          <div key={c.id} className="bg-white rounded-2xl p-4 border border-blue-100 flex flex-col gap-4 relative overflow-hidden group shadow-sm hover:shadow-md transition">
                            {/* Indicator */}
                  ...
                  <div className="space-y-3 mt-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {allClasses.filter(c => c.type === "alumni").map((c) => {
                        const isEditing = editingClassId === c.id;
                        return (
                          <div key={c.id} className="bg-white rounded-2xl p-4 border border-emerald-100 flex flex-col gap-4 relative overflow-hidden group shadow-sm hover:shadow-md transition">
                            {/* Indicator */}
...
console.log("Patch AdminKelasSegment done!");
