                                        ...
                                        {isInterested || isApproved ? (
                                          ...
                                          (() => {
                                            ...
                                            if (me && job) {
                                              ...
                                              // calc average
                                              const records =
                                                systemState.attendance.filter(
                                                  (r) =>
                                                    r.studentName === me.name ||
                                                    r.studentId === me.id,
                                                );
                                              const rateAtt =
                                                records.length > 0
                                              ...
                                              if (
                                                ...
                                                isEligible = false;
                                                autoRejectNote += `MTK (${mathScore} < ${reqMath}). `;
                                              }
                                              if (
                                                reqFiveS > 0 &&
                                                fiveSScore < reqFiveS
                                                ...
                                                isEligible = false;
                                                autoRejectNote += `5S (${fiveSScore} < ${reqFiveS}). `;
                                              }
                                              if (
                                                reqEthics > 0 &&
                                                ethicsScore < reqEthics
                                              ) {
                                                isEligible = false;
                                                autoRejectNote += `Etika (${ethicsScore} < ${reqEthics}). `;
                                              }
                                              if (
                                                reqAttendance > 0 &&
                                                attendanceScore < reqAttendance
                                              ) {
                                                isEligible = false;
                                                autoRejectNote += `Absensi (${attendanceScore}% < ${reqAttendance}%). `;
                                              }
                                              if (
                                                minTB > 0 &&
                                                myTB > 0 &&
                                                ...
                                                isEligible = false;
                                                autoRejectNote += `TB (${myTB}cm < ${minTB}cm). `;
                                              }
                                              if (
                                                maxTB > 0 &&
                                                myTB > 0 &&
                                                ...
                                                isEligible = false;
                                                autoRejectNote += `TB (${myTB}cm > ${maxTB}cm). `;
                                              }
                                              if (
                                                minBB > 0 &&
                                                myBB > 0 &&
                                                ...
                                                isEligible = false;
                                                autoRejectNote += `BB (${myBB}kg < ${minBB}kg). `;
                                              }
                                              if (
                                                maxBB > 0 &&
                                                myBB > 0 &&
                                                ...
                                                isEligible = false;
                                                autoRejectNote += `BB (${myBB}kg > ${maxBB}kg). `;
                                              }
                                              if (
                                                minAge > 0 &&
                                                myAge > 0 &&
                                                ...
                                                isEligible = false;
                                                autoRejectNote += `Usia (${myAge}th < ${minAge}th). `;
                                              }
                                              if (
                                                maxAge > 0 &&
                                                myAge > 0 &&
                                                ...
                                                isEligible = false;
                                                autoRejectNote += `Usia (${myAge}th > ${maxAge}th). `;
                                              }
                                              if (
                                                minJpn > 0 &&
                                                myJpn > 0 &&
                                                ...
                                                isEligible = false;
                                                autoRejectNote += `B.Jepang (Bab ${myJpn} < Bab ${minJpn}). `;
                                              }
                                              if (
                                                reqGender &&
                                                reqGender !==
                                                ...
                                                if (
                                                  !reqGender.includes(myGender)
                                                ) {
                                                  isEligible = false;
                                                  autoRejectNote += `Gender (${me.gender} tdk sesuai). `;
                                                }
                                              }
                                            }
