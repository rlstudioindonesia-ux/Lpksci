...
import AdminGajiSegment from "./admin/AdminGajiSegment";
import AdminKustomisasiSegment from "./admin/AdminKustomisasiSegment";
  ...
  return (
    <div className="flex flex-row gap-3 sm:gap-6 py-4 sm:py-6 relative items-start">
      ...
      <div className="flex-1 min-w-0 space-y-6 sm:space-y-8 pb-10">
        ...
        {activeSegment === "kustomisasi" && <AdminKustomisasiSegment custFaviconDragActive={custFaviconDragActive} custFaviconUrl={custFaviconUrl} custLandingConfig={custLandingConfig} custLogoDragActive={custLogoDragActive} custLogoIcon={custLogoIcon} custLogoText={custLogoText} custLogoUrl={custLogoUrl} custSlides={custSlides} custThemeColor={custThemeColor} handleFaviconDrag={handleFaviconDrag} handleFaviconDrop={handleFaviconDrop} handleFaviconFileChange={handleFaviconFileChange} handleLogoDrag={handleLogoDrag} handleLogoDrop={handleLogoDrop} handleLogoFileChange={handleLogoFileChange} handleSaveCustomization={handleSaveCustomization} landingSaveSuccess={landingSaveSuccess} officeEnforce={officeEnforce} officeLat={officeLat} officeLon={officeLon} officeRadius={officeRadius} onUpdateState={onUpdateState} oppUploadStatus={oppUploadStatus} saveSuccess={saveSuccess} selectedSlideId={selectedSlideId} setCustFaviconUrl={setCustFaviconUrl} setCustLandingConfig={setCustLandingConfig} setCustLogoIcon={setCustLogoIcon} setCustLogoText={setCustLogoText} setCustLogoUrl={setCustLogoUrl} setCustSlides={setCustSlides} setCustThemeColor={setCustThemeColor} setLandingSaveSuccess={setLandingSaveSuccess} setOfficeEnforce={setOfficeEnforce} setOfficeLat={setOfficeLat} setOfficeLon={setOfficeLon} setOfficeRadius={setOfficeRadius} setOppUploadStatus={setOppUploadStatus} setSelectedSlideId={setSelectedSlideId} setSlideSaveSuccess={setSlideSaveSuccess} setSliderUploadStatus={setSliderUploadStatus} slideSaveSuccess={slideSaveSuccess} sliderUploadStatus={sliderUploadStatus} />}
