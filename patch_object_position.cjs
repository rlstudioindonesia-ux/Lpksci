...
// If using background-image doesn't play well with the specific image dimensions, 
// a robust fallback is center 5% (which is mathematically valid and guarantees 5% from top).
