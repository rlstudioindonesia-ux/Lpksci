...
code = code.replace(
  ...
  `className="relative overflow-hidden rounded-2xl bg-slate-950 text-white min-h-[190px] sm:aspect-[16/9] border border-slate-200/20 shadow-md flex flex-col justify-between transition-all duration-500"`
);
