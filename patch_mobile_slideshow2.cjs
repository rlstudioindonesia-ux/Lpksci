...
code = code.replace(
  `className="relative overflow-hidden rounded-2xl bg-slate-950 text-white aspect-[4/3] min-h-[280px] sm:min-h-[320px] border border-slate-200/20 shadow-md flex flex-col justify-between transition-all duration-500"`,
