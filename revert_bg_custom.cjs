...
// The issue might be that bg-top clips the VERY top of the image on certain aspect ratios. 
// Let's try explicitly setting background position to 0% 10% (x y) to pull it down slightly
